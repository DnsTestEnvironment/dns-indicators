if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => {
        navigator.serviceWorker.register('/dns-indicators/service-worker.js');
    });
}
/**
