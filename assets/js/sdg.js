...
var mapView = function () {
  ...
  this.initialise = function(indicatorId, precision, precisionItems, decimalSeparator, thousandsSeparator, dataSchema, viewHelpers, modelHelpers, chartTitles, chartSubtitles) {
    ...
    $('#map').sdgMap({
      ...
      mapLayers: [{"serviceUrl":"https://DnsTestEnvironment.github.io/dns-indicators/assets/maps/boundaries.geojson","min_zoom":0,"max_zoom":6,"staticBorders":true,"subfolder":"laender","label":"indicator.laender"},{"serviceUrl":"https://DnsTestEnvironment.github.io/dns-indicators/assets/maps/boundariesKrs.geojson","min_zoom":7,"max_zoom":11,"staticBorders":false,"subfolder":"kreise","label":"indicator.counties"}],
      precision: precision,
