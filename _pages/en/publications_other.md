...
<figure style="width: 20%; margin-left: 10px; float: right; border: 1px solid #ddd; border-radius: 4px;"><img src="https://dnstestenvironment.github.io/dns-indicators//assets/img/report/wista.png" alt="Figure 1: DNS Logo" style="width: 100%; padding-left: 20px; padding-right:20px; padding-bottom:10px; padding-top:10px;"><figcaption style="margin-bottom:20px; text-align: center"><small>Fig. 1: DNS Logo</small></figcaption></figure>Extract from the publication „WISTA - Wirtschaft und Statistik“, 1/2017
...
<br>
<figure style="width: 20%; margin-left: 10px; float: right; border: 1px solid #ddd; border-radius: 4px;"><img src="https://dnstestenvironment.github.io/dns-indicators//assets/img/report/sawGebietsstand.png" alt="Figure 1: Special evaluation by territorial status" style="width: 100%; padding-left: 20px; padding-right:20px; padding-bottom:10px; padding-top:10px;"><figcaption style="margin-bottom:20px; text-align: center"><small>Fig 1: Special evaluation by territorial status</small></figcaption></figure>Publication of selected indicators by territorial status: New Länder with Berlin, New Länder without Berlin, Former Federal Territory.
