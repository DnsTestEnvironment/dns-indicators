...
### [New Edition of the German Sustainable Development Strategy](https://dns-indikatoren.de/assets/publications/wista2017_01.pdf)
...
<br><br>
### [Feasibility study on the presentation of the indicators of the German Sustainable Development Strategy by federal states (only available in German)](https://dns-indikatoren.de/assets/publications/machbarkeitsstudie.pdf)
<br>
...
<br>
<figure style="width: 20%; margin-left: 10px; float: right; border: 1px solid #ddd; border-radius: 4px;"><img src="https://dnstestenvironment.github.io/dns-indicators//assets/img/report/sawGebietsstand.PNG" alt="Figure 3: Special evaluation by territorial status" style="width: 100%; padding-left: 20px; padding-right:20px; padding-bottom:10px; padding-top:10px;"><figcaption style="margin-bottom:20px; text-align: center"><small>Fig. 3: Special evaluation by territorial status</small></figcaption></figure>
